# sample UI5-/Fori-application for golem.de-article

## Description

This app demonstrates a TypeScript setup for developing UI5 applications with Fiori optics.

**This sample was saffolded with `easy-ui5` and [the `generator-ui5-ts-app`](https://github.com/ui5-community/generator-ui5-ts-app). See [a detailed step-by-step guide](https://github.com/SAP-samples/ui5-typescript-helloworld/blob/main/step-by-step.md) to get going with UI5 and TypeScript. It explains how this setup is created and how all the bits and pieces fit together**
